...
(setq modus-themes-common-palette-overrides
      `((bg-line-number-active unspecified)
        ...
        (fringe "#0d0e1c")))
;;    `((bg-main "#1a1b26") ;292D3E
;;      (bg-active bg-main)
;;      (fg-main "#EEFFFF") ;EEFFFF Supposed to be a9b1d6
;;      (fg-active fg-main)
...
;;      (bg-line-number-active unspecified)
;;      (bg-line-number-inactive "#1a1b26") ;292D3E
;;      (fringe "#1a1b26") ;292D3E

;;      (fg-heading-0 "#7dcfff")
;;      (fg-heading-1 "#7dcfff") ;82aaff
;;      (fg-heading-2 "#bb9af7") ;c792ea
;;      (fg-heading-3 "#e0af68") ;bb80b3
;;      (fg-heading-4 "#9ece6a") ;a1bfff
;;      (fg-heading-5 "#b4f9f8")
;;      (fg-heading-6 "#f7768e")
