          ...
          (lambda ()
            (if emacs-solo/eshell-full-prompt
                ...
                (concat
                 ...
                 (propertize
                  (concat " 🕒 " (format-time-string "%I:%M:%S %p" (current-time)) " ")
                  'face `(:foreground "#89b4fa" :background "#45475A"))
...
(use-package org
  ...
  (setq
   ...
   org-tags-exclude-from-inheritance '("project" "epic")
   org-todo-keywords '((sequence "TODO(t)" "WAITING(w@/!)" "|" "ABANDONED(a)" "DONE(d!)"))
